...
import com.d_vide.D_VIDE.app.data.remote.responseDTO.Review.ReviewDetailDTO
...
class GetReviewDetail @Inject constructor(
    private val repository: ReviewRepository,
) {
    operator fun invoke( reviewId: Long ): Flow<Resource<ReviewDetailDTO>> = flow {
